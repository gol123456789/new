...
class Mgt_DeveloperToolbar_Block_Toolbar extends Mgt_DeveloperToolbar_Block_Template
{
    ...
    protected function _addDefaultItems()
    {
        ...
        $this->_addItem(new Mgt_DeveloperToolbar_Block_Toolbar_Item_ConfigDump('ConfigDump','configD'));
        $this->_addItem(new Mgt_DeveloperToolbar_Block_Toolbar_Item_ClassDump('ClassDump','ClassDump'));
    }
