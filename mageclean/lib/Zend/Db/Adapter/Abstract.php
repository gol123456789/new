...
abstract class Zend_Db_Adapter_Abstract
{
    ...
    public function logIt($result, $object){
    
  //  $profiler =  My_Mod_Helper_Profiler::register();
  //  $profiler->log($result, $object);
    //  Mage::helper("mymod/profiler")->log($result, $object);
    }
